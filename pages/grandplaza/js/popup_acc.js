$(document).ready(function(){
	...
	var obj_wrap=$(".accom .inner");
	//움직일 오브젝트의 이름
	var obj_name = $(".accom .inner ul");
	//보여질 실제 팝업을 감싸고 있는 영역
	var obj_child = $(".accom .inner ul li");
	...
	var ctrl_next = $(".accom .next");
	var ctrl_prev = $(".accom .prev");
	var ctrl_stop = $(".accom .popup .stop");
	var ctrl_play = $(".accom .popup .play");
	...
	var paging_obj = $(".accom .ctrl_btn_m .paging button");
