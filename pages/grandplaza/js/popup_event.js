$(document).ready(function(){
	...
	var obj_wrap=$(".event .popup");
	//움직일 오브젝트의 이름
	var obj_name = $(".event .popup ul");
	//보여질 실제 팝업을 감싸고 있는 영역
	var obj_child = $(".event .popup ul li");
	...
	var ctrl_next = $(".event .ctrl_btn .next");
	var ctrl_prev = $(".event .ctrl_btn .prev");
	var ctrl_stop = $(".event .popup .stop");
	var ctrl_play = $(".event .popup .play");
	...
	var paging_obj = $(".event .ctrl_btn_m .paging button");
