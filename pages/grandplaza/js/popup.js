$(document).ready(function(){
	...
	var obj_wrap=$(".visual");
	//팝업 전체를 묶어주는 요소
	var obj_name = $(".visual ul");
	//보여질 실제 팝업을 감싸고 있는 영역
	var obj_child = $(".visual ul li");
	...
	var ctrl_next = $(".visual .popup .next");
	var ctrl_prev = $(".visual .popup .prev");
	var ctrl_stop = $(".visual .ctrl_btn .stop");
	var ctrl_play = $(".visual .ctrl_btn .play");
	...
	var paging_obj = $(".visual .ctrl_btn .paging button");
