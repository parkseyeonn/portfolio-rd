$(document).ready(function(){
	...
	var obj_wrap=$(".notice .perform .popup");
	//움직일 오브젝트의 이름
	var obj_name = $(".notice .perform .popup ul");
	//보여질 실제 팝업을 감싸고 있는 영역
	var obj_child = $(".notice .perform .popup ul li");
	...
	var paging_obj = $(".notice .perform .paging button");
