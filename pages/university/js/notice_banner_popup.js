$(document).ready(function(){
	...
	var obj_wrap=$(".notice .banner .popup");
	//움직일 오브젝트의 이름
	var obj_name = $(".notice .banner .popup ul");
	//보여질 실제 팝업을 감싸고 있는 영역
	var obj_child = $(".notice .banner .popup ul li");
	...
	var ctrl_next = $(".notice .banner .ctrl_btn .next");
	var ctrl_prev = $(".notice .banner .ctrl_btn .prev");
	var ctrl_stop = $(".notice .banner .ctrl_btn .stop");
	var ctrl_play = $(".notice .banner .ctrl_btn .play");
