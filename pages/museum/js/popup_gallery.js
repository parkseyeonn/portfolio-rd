$(document).ready(function(){
	...
	var obj_wrap=$(".gallery .popup");
	//움직일 오브젝트의 이름
	var obj_name = $(".gallery .popup ul");
	//보여질 실제 팝업을 감싸고 있는 영역
	var obj_child = $(".gallery .popup ul li");
	...
	var ctrl_next = $(".gallery .popup .next");
	var ctrl_prev = $(".gallery .popup .prev");
	var ctrl_stop = $(".gallery .popup .stop");
	var ctrl_play = $(".gallery .popup .play");
