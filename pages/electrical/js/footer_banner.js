...
*/
	...
	var obj_wrap = $("#footer .banner"); //높이 제어
	var obj_name = $("#footer .banner ul"); // 실제 움직일놈
	var obj_child = $("#footer .banner ul li");// 하나의 팝업

	//팝업 컨트롤버튼
	var ctrl_btn = true;//사용여부 (true, false)
	var ctrl_next = $("#footer .footer_top .ctrl_btn .next");
	var ctrl_prev = $("#footer .footer_top .ctrl_btn .prev");
	var ctrl_stop = $("#footer .footer_top .ctrl_btn .stop");
	var ctrl_play = $("#footer .footer_top .ctrl_btn .play");
