$(document).ready(function(){
	...
	var obj_wrap=$(".notice .popup");
	//움직일 오브젝트의 이름
	var obj_name = $(".notice .popup ul");
	//보여질 실제 팝업을 감싸고 있는 영역
	var obj_child = $(".notice .popup ul li");
	...
	var ctrl_next = $(".notice .ctrl_panel .btn_next");
	var ctrl_prev = $(".notice .ctrl_panel .btn_prev");
	var ctrl_stop = $(".notice .ctrl_panel .btn_stop");
	var ctrl_play = $(".notice .ctrl_panel .btn_play");

	//현재팝업 번호 / 전체 팝업번호
	var numbering = true;//사용여부 (true, false)
	var curr_num = $(".notice .ctrl_panel .num span.current");
	var total_num = $(".notice .ctrl_panel .num span.total");
