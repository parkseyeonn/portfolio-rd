...
*/
	...
	var obj_wrap = $(".visual .quick .wrap"); //높이 제어
	var obj_name = $(".visual .quick .wrap .inner"); // 실제 움직일놈
	var obj_child = $(".visual .quick .wrap .inner .quick_menu");// 하나의 팝업

	//팝업 컨트롤버튼
	var ctrl_btn = true;//사용여부 (true, false)
	var ctrl_next = $(".visual .quick .ctrl_btn .quick_next");
	var ctrl_prev = $(".visual .quick .ctrl_btn .quick_prev");
	var ctrl_stop = $(".visual .quick .stop");
	var ctrl_play = $(".visual .quick .play");
